...
@File: a2_cifar10_extract.py
@Time: 2019-08-08 11:18
@Last_update: 2019-08-08 11:18
@Desc: None
@==============================================@
@      _____             _   _     _   _       @
...
if __name__ == '__main__':
  ...
  with tf.Session() as sess:
    ...
    reshaped_image = inputs_origin('data/cifar10_data/cifar-10-batches-bin')
    ...
    for i in range(30):
      ...
      # 将图片保存
      scipy.misc.toimage(image_array).save('data/cifar10_data/extract/%d.jpg' % i)